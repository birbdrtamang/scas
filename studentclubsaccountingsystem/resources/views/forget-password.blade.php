...
<body>
    <div class="container-fluid">
        ...
        <span style="font-size:small">We will send a password reset link to this email.</span>
        <form action="{{route('reset-password-link')}}" method="POST" class="resetForm" data-aos="fade-zoom-in" data-aos-duration="1000">
            @csrf
            <div class="mb-3">
